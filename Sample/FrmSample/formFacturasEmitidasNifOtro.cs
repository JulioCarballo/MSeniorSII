...
namespace Sample
{
    public partial class formFacturasEmitidasNifOtro : Form
    {
        ...
        private static ARInvoicesBatch CreaLoteDeFacturasEmitidas()
        {
            ...
            facturaEnviadaPrimera.InvoiceNumber = "E00001"; // El número de factura
        ...
        public void EnviarLoteFacturasEmitidas()
        {
            ...
            facturaExpedida.Contraparte.IDOtro.IDType = "06";
            facturaExpedida.Contraparte.IDOtro.CodigoPais = "US";
            facturaExpedida.Contraparte.IDOtro.ID = "NIF_EXTRANJERO";
