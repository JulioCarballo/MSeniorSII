...
namespace Sample
{
    public partial class formBajaFacturasRecibidas : Form
    {
        ...
        private static APInvoicesDeleteBatch CrearLoteFacturaRecibidasEliminar()
        {
            ...
            primeraFacturaEliminar.PostingDate = new DateTime(2017, 1, 15); // Fecha de contabilización
            primeraFacturaEliminar.SellerParty = new Party() // Acreedor (Emisor factura)
            {
                TaxIdentificationNumber =
                "B12756474",
                PartyName = "MAC ORGANIZACION SL"
            };
            primeraFacturaEliminar.BuyerParty = titular; // Comprador
            primeraFacturaEliminar.InvoiceNumber = "00001"; // Número de factura
