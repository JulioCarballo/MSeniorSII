...
namespace Sample
{
    public partial class formPagosRecibidas : Form
    {
        ...
        private static APInvoicesPaymentsBatch CrearLotePagosFacturasRecibidas()
        {
            ...
            LotePagosFacturasRecibidas.Titular = titular;
            ...
            facturaRecibidaPagadaPrimera.IssueDate = new DateTime(2017, 1, 15); // Fecha emisión
            facturaRecibidaPagadaPrimera.PostingDate = new DateTime(2017, 1, 15); // Fecha contabilización
            facturaRecibidaPagadaPrimera.SellerParty = new Party() // Acreedor (emisor factura)
            {
                TaxIdentificationNumber =
                "B12756474",
                PartyName = "MAC ORGANIZACION SL"
            };
            facturaRecibidaPagadaPrimera.BuyerParty = comprador; // Comprador
            facturaRecibidaPagadaPrimera.InvoiceNumber = "00001"; // Número factura
            ...
            facturaRecibidaPagadaSegunda.IssueDate = new DateTime(2017, 1, 15); // Fecha factura
            facturaRecibidaPagadaSegunda.PostingDate = new DateTime(2017, 1, 15); // Fecha contabilización
            facturaRecibidaPagadaSegunda.SellerParty = new Party() // acreedor (emisor factura)
            {
                TaxIdentificationNumber =
                "B12756474",
                PartyName = "MAC ORGANIZACION SL"
            };
            facturaRecibidaPagadaSegunda.BuyerParty = comprador; // Comprador
            facturaRecibidaPagadaSegunda.InvoiceNumber = "00002"; // Número factura
