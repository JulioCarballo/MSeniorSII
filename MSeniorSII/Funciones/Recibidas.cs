...
namespace MSeniorSII
{
    class Recibidas
    {
        ...
        private Party TratarRegCabecera(string[] _CamposReg)
        {
            ...
            {
                PartyName = (_CamposReg[1]).Trim(),
                TaxIdentificationNumber = _CamposReg[2]
            };
        ...
        private APInvoice TratarFactRecibida(string[] _CamposReg, Party _Titular)
        {
            ...
            Party _Emisor = new Party
            {
                ...
                PartyName = _CamposReg[12].Trim(),
                TaxIdentificationNumber = _CamposReg[3]
            };
        ...
        private APInvoice AgregarFactRectifica(string[] _CamposReg, APInvoice _FacturaActual)
        {
            ...
            {
                RectifiedInvoiceNumber = (_CamposReg[1]).Trim(),
                RectifiedIssueDate = Convert.ToDateTime(_CamposReg[2])
            };
