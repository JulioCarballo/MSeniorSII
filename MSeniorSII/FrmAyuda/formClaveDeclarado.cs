...
{
    public partial class FormClaveDeclarado : Form
    {
        public string SelectedClave { get; private set; }

        public FormClaveDeclarado()
        {
            InitializeComponent();
        }

        private void FormClaveDeclarado_Load(object sender, EventArgs e)
        {
            Fill();
        }
        ...
        private void Fill()
        {
            ...
            foreach (KeyValuePair<string, string> kvp in General.ClaveDeclarado)
        ...
        private void SelectClave()
        {
            if (grdPaises.SelectedRows.Count > 0)
            {
                SelectedClave = grdPaises.SelectedRows[0].Cells[0].Value.ToString();
                Close();
            }
        }
