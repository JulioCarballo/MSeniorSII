...
{
    public partial class FormEstadosUE : Form
    {
        public string SelectdCountry { get; private set; }

        public FormEstadosUE()
        {
            InitializeComponent();
        }

        private void FormEstadosUE_Load(object sender, EventArgs e)
        {
            Fill();
        }
        ...
        private void Fill()
        {
            ...
            foreach (KeyValuePair<string, string> kvp in General.EstadosMiembros)
